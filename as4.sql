...
--3.Write a query to get the employee ID, names (first_name, last_name), salary in ascending order of
salary.
...
--10.Display employees first_name,email who are working in “Executive” department.
        ...
        select e.first_name,e.email, d.department_id from employees e ,departments d 
        where d.department_name= 'Executive' and e.department_id=d.department_id;
